...
namespace Sapiha\Import\Block\Adminhtml\Category\Edit;
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'note' => __('If you chose delete strategy the products will be deleted by sku from file'),
                'values' => [
                    1 => __('Remove all category products'),
                    0 => __('Do not remove category products'),
                ]
            ]
        );
        $fieldset->addField(
